...
import {setAIComponent} from '../reducers/ai-component.js'
...
const mapDispatchToProps = (dispatch) => ({
    ...
    onSetAIComponentOpen: () => dispatch(setAIComponent(true)),
    onSetAIComponentClose: () => dispatch(setAIComponent(false)),
});
